...
customElements.define('action-handler-swipe-glance-card', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-swipe-glance-card')) {
    return body.querySelector('action-handler-swipe-glance-card') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-swipe-glance-card');
